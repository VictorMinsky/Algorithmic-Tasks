...
k = int(input())
all_combinations = combinations(letters, k)
all_combinations_length = factorial(n) // (factorial(k) * factorial(n - k))
all_combinations_with_character = 0
for combination in all_combinations:
    if 'a' in combination:
        all_combinations_with_character += 1
print(all_combinations_with_character / all_combinations_length)
